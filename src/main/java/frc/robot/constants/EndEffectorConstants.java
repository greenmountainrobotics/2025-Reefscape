...
public class EndEffectorConstants {
  ...
  public static final Rotation2d CoralPlacementPosition = new Rotation2d(-55 * (Math.PI / 180));
  public static final Rotation2d CoralL4PlacementPosition = new Rotation2d(-90 * (Math.PI / 180));
  public static final Rotation2d CoralPickupRotation = new Rotation2d(35 * (Math.PI / 180));
  ...
  public static final double ArticulationToleranceRad = 0.05;
