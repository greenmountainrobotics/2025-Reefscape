...
public class IntakeIOSim implements IntakeIO {
  ...
  private DCMotorSim intakeSpinMotorSim =
      new DCMotorSim(
          LinearSystemId.createDCMotorSystem(intakeSpinMotor, 1.0, 100), intakeSpinMotor);
  private DCMotorSim intakeRotateMotorSim =
      new DCMotorSim(
          LinearSystemId.createDCMotorSystem(intakeRotateMotor, 1.0, 80), intakeRotateMotor);
