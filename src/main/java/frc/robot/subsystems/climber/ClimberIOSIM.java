...
public class ClimberIOSIM implements ClimberIO {
  ...
  private DCMotorSim leftHangMotorSim =
      new DCMotorSim(LinearSystemId.createDCMotorSystem(leftHangMotor, 1.0, 1.0), leftHangMotor);

  private DCMotorSim rightHangMotorSim =
      new DCMotorSim(LinearSystemId.createDCMotorSystem(rightHangMotor, 1.0, 1.0), rightHangMotor);
